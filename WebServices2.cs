	...
	public partial class ScriptMain : Microsoft.SqlServer.Dts.Tasks.ScriptTask.VSTARTScriptObjectModelBase
	{
		...
		public void Main()
		{
            ...
            */
            ...
            String dataPost = "{ \n  \"scenarioKey\":\"FD90D1C5456A5E9D583333426591F5C9\",  \n  \"destinations\":[{ \n  \"to\":{\n  \"phoneNumber\": \"573196943080\"\n }\n }], \n  \"whatsApp\":{\n \"templateName\": \"welcome_multiple_languages\",\n \"templateNamespace\": \"whatsapp:hsm:it:infobip\",\n  \"templateData\":[\"Xime\"],\n \"language\": \"es\"\n  }\n  }";
            byte[] byteArray = Encoding.UTF8.GetBytes(dataPost);

            var URI = new Uri("https://463e1.api.infobip.com/omni/1/advanced");
            
            wc.Headers["Content-Type"] = "application/json";
            wc.Headers[HttpRequestHeader.Authorization] = string.Format("Basic {0}", authInfo);

            //If any key needed

            byte[] response = wc.UploadData(URI, byteArray);

           // wc.UploadStringAsync(URI, "POST", dataPost);
...
namespace ST_7da6c94b18514c54a093f10eb52828ed
{
	...
	public partial class ScriptMain : Microsoft.SqlServer.Dts.Tasks.ScriptTask.VSTARTScriptObjectModelBase
	{
		...
		public void Main()
		{
            ...
            String dataPost = "{\n \"scenarioKey\": \"FD90D1C5456A5E9D583333426591F5C9\", \n \"destinations\": [{\n \t \"to\": { \n \t \t \"phoneNumber\": \"573196943080\" \n \t	}\n \r }], \n \"whatsApp\": { \n \t \"text\": \"Respuesta despues del HSM prueba de SSIS\",\n \t \"fileUrl\": \"https://facturaelectronica.blob.core.windows.net/facturaelectronica/SQL_Server_2019_Transform-Data_into_Insights_Infographic_EN_US.pdf \" \n }\n}";
            byte[] byteArray = Encoding.UTF8.GetBytes(dataPost);
